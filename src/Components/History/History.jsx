    ...
    return (
        ...
        <div className="w-screen flex flex-col items-stretch mt-16 mb-auto ">
            <div className="flex flex-row gap-x-96">
                <h1 className="text-6xl font-black mt-auto mb-20 ml-16">Watch History</h1>
        ...
        <p class="block font-sans text-3xl antialiased font-semibold leading-normal tracking-normal text-blue-gray-900">
                    date 2
                </p>
            <li className="w-fit">
